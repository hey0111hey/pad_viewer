...
Asset.assets = [
  ...
  { type: 'board', name: 'board7', src: 'assets/set/way_without_otikon/way_without_otikon7_board.dat'},
  { type: 'board', name: 'board8', src: 'assets/set/way_without_otikon/way_without_otikon8_board.dat'},
  { type: 'board', name: 'board9', src: 'assets/set/way_without_otikon/way_without_otikon9_board.dat'},
  { type: 'board', name: 'board10',src: 'assets/set/way_without_otikon/way_without_otikon10_board.dat'},
  { type: 'board', name: 'board11',src: 'assets/set/way_without_otikon/way_without_otikon11_board.dat'},
  { type: 'board', name: 'board12',src: 'assets/set/way_without_otikon/way_without_otikon12_board.dat'},
  { type: 'board', name: 'board13',src: 'assets/set/way_without_otikon/way_without_otikon13_board.dat'},
  { type: 'board', name: 'board14',src: 'assets/set/way_without_otikon/way_without_otikon14_board.dat'},
  { type: 'board', name: 'board15',src: 'assets/set/way_without_otikon/way_without_otikon15_board.dat'},
  { type: 'board', name: 'board16',src: 'assets/set/way_without_otikon/way_without_otikon16_board.dat'},
  { type: 'board', name: 'board17',src: 'assets/set/way_without_otikon/way_without_otikon17_board.dat'},
  { type: 'board', name: 'board18',src: 'assets/set/way_without_otikon/way_without_otikon18_board.dat'},
  { type: 'board', name: 'board19',src: 'assets/set/way_without_otikon/way_without_otikon19_board.dat'},
  { type: 'board', name: 'board20',src: 'assets/set/way_without_otikon/way_without_otikon20_board.dat'},
  { type: 'board', name: 'board21',src: 'assets/set/way_without_otikon/way_without_otikon21_board.dat'},
  { type: 'board', name: 'board22',src: 'assets/set/way_without_otikon/way_without_otikon22_board.dat'},
  { type: 'board', name: 'board23',src: 'assets/set/way_without_otikon/way_without_otikon23_board.dat'},
  { type: 'score', name: 'score7', src: 'assets/set/way_without_otikon/way_without_otikon7_score.dat'},
  { type: 'score', name: 'score8', src: 'assets/set/way_without_otikon/way_without_otikon8_score.dat'},
  { type: 'score', name: 'score9', src: 'assets/set/way_without_otikon/way_without_otikon9_score.dat'},
  { type: 'score', name: 'score10',src: 'assets/set/way_without_otikon/way_without_otikon10_score.dat'},
  { type: 'score', name: 'score11',src: 'assets/set/way_without_otikon/way_without_otikon11_score.dat'},
  { type: 'score', name: 'score12',src: 'assets/set/way_without_otikon/way_without_otikon12_score.dat'},
  { type: 'score', name: 'score13',src: 'assets/set/way_without_otikon/way_without_otikon13_score.dat'},
  { type: 'score', name: 'score14',src: 'assets/set/way_without_otikon/way_without_otikon14_score.dat'},
  { type: 'score', name: 'score15',src: 'assets/set/way_without_otikon/way_without_otikon15_score.dat'},
  { type: 'score', name: 'score16',src: 'assets/set/way_without_otikon/way_without_otikon16_score.dat'},
  { type: 'score', name: 'score17',src: 'assets/set/way_without_otikon/way_without_otikon17_score.dat'},
  { type: 'score', name: 'score18',src: 'assets/set/way_without_otikon/way_without_otikon18_score.dat'},
  { type: 'score', name: 'score19',src: 'assets/set/way_without_otikon/way_without_otikon19_score.dat'},
  { type: 'score', name: 'score20',src: 'assets/set/way_without_otikon/way_without_otikon20_score.dat'},
  { type: 'score', name: 'score21',src: 'assets/set/way_without_otikon/way_without_otikon21_score.dat'},
  { type: 'score', name: 'score22',src: 'assets/set/way_without_otikon/way_without_otikon22_score.dat'},
  { type: 'score', name: 'score23',src: 'assets/set/way_without_otikon/way_without_otikon23_score.dat'},
];
//読み込んだ画像
Asset.images ={};
//読み込んだきゃんぱす
